...
import com.hcq.elion.client.gateway.GatewayClient;
...
import static com.hcq.elion.tools.config.CC.elion.net.gateway_client_num;
...
public class GatewayTCPConnectionFactory extends GatewayConnectionFactory {
    ...
    public GatewayTCPConnectionFactory(ElionClient elionClient) {
    ...
    protected void doStart(Listener listener) throws Throwable {
        ...
        gatewayClient = new GatewayClient(elionClient);
