...
import static com.hcq.elion.tools.config.CC.elion.thread.pool.http_work;
import static com.hcq.elion.tools.thread.ThreadNames.T_HTTP_TIMER;
...
public class NettyHttpClient extends BaseService implements HttpClient {
    ...
    private static final int maxContentLength = (int) CC.elion.http.max_content_length;
