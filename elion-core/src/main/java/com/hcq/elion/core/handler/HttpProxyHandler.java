...
import com.hcq.elion.common.message.HttpRequestMessage;
import com.hcq.elion.common.message.HttpResponseMessage;
import com.hcq.elion.core.ElionServer;
import com.hcq.elion.network.netty.http.HttpCallback;
import com.hcq.elion.network.netty.http.HttpClient;
import com.hcq.elion.network.netty.http.RequestContext;
...
public class HttpProxyHandler extends BaseMessageHandler<HttpRequestMessage> {
    ...
    public HttpProxyHandler(ElionServer elionServer) {
        this.httpClient = elionServer.getHttpClient();
    }
