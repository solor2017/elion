...
import com.hcq.elion.common.condition.AwaysPassCondition;
import com.hcq.elion.common.message.PushMessage;
import com.hcq.elion.common.qps.FlowControl;
import com.hcq.elion.common.qps.OverFlowException;
...
public final class BroadcastPushTask implements PushTask {
    ...
    public BroadcastPushTask(ElionServer elionServer, IPushMessage message, FlowControl flowControl) {
        this.elionServer = elionServer;
        this.message = message;
        this.flowControl = flowControl;
        this.condition = message.getCondition();
        this.iterator = elionServer.getRouterCenter().getLocalRouterManager().routers().entrySet().iterator();
    ...
    private void report() {
        ...
        elionServer.getPushCenter().getPushListener().onBroadcastComplete(message, timeLine.end().getTimePoints());//通知发送方，广播推送完毕
    }
