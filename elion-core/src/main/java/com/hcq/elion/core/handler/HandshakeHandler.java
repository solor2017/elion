...
import com.hcq.elion.common.message.HandshakeMessage;
import com.hcq.elion.common.message.HandshakeOkMessage;
import com.hcq.elion.common.security.AesCipher;
import com.hcq.elion.common.security.CipherBox;
...
import static com.hcq.elion.common.ErrorCode.REPEAT_HANDSHAKE;
...
public final class HandshakeHandler extends BaseMessageHandler<HandshakeMessage> {
    ...
    public HandshakeHandler(ElionServer elionServer) {
