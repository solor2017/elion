...
import com.hcq.elion.api.spi.handler.BindValidator;
import com.hcq.elion.api.spi.handler.BindValidatorFactory;
import com.hcq.elion.common.handler.BaseMessageHandler;
import com.hcq.elion.common.message.BindUserMessage;
...
import com.hcq.elion.core.router.LocalRouterManager;
...
public final class BindUserHandler extends BaseMessageHandler<BindUserMessage> {
    ...
    public BindUserHandler(ElionServer elionServer) {
        this.routerCenter = elionServer.getRouterCenter();
        this.bindValidator.init(elionServer);
    }
