...
import static com.hcq.elion.tools.config.CC.elion.net.gateway_server_bind_ip;
...
import static com.hcq.elion.tools.config.CC.elion.net.write_buffer_water_mark.gateway_server_high;
import static com.hcq.elion.tools.config.CC.elion.net.write_buffer_water_mark.gateway_server_low;
...
public final class GatewayServer extends NettyTCPServer {
    ...
    public GatewayServer(ElionServer elionServer) {
    ...
    public void init() {
        ...
        if (CC.elion.net.traffic_shaping.gateway_server.enabled) {//启用流量整形，限流
    ...
    protected int getWorkThreadNum() {
        return CC.elion.thread.pool.gateway_server_work;
    }
    ...
    public ChannelFactory<? extends ServerChannel> getChannelFactory() {
        ...
        if (CC.elion.net.udtGateway()) return NioUdtProvider.BYTE_ACCEPTOR;
        if (CC.elion.net.sctpGateway()) return NioSctpServerChannel::new;
