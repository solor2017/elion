...
public interface CC {
    ...
    static Config load() {
        ...
        String custom_conf = "elion.conf";//加载自定义配置, 值来自jvm启动参数指定-Delion.conf
    ...
    interface elion {
        Config cfg = CC.cfg.getObject("elion").toConfig();
        ...
        interface core {
            Config cfg = elion.cfg.getObject("core").toConfig();
            ...
            static boolean useNettyEpoll() {
                if (!"netty".equals(elion.core.epoll_provider)) return false;
        ...
        interface net {
            Config cfg = elion.cfg.getObject("net").toConfig();
        ...
        interface security {
            ...
            Config cfg = elion.cfg.getObject("security").toConfig();
        ...
        interface thread {
            ...
            Config cfg = elion.cfg.getObject("thread").toConfig();
        ...
        interface zk {
            ...
            Config cfg = elion.cfg.getObject("zk").toConfig();
        ...
        interface redis {
            Config cfg = elion.cfg.getObject("redis").toConfig();
        ...
        interface http {
            ...
            Config cfg = elion.cfg.getObject("http").toConfig();
        ...
        interface push {
            ...
            Config cfg = elion.cfg.getObject("push").toConfig();
        ...
        interface monitor {
            Config cfg = elion.cfg.getObject("monitor").toConfig();
