...
import com.hcq.elion.tools.crypto.RSAUtils;
...
public final class CipherBox {
    public final int aesKeyLength = CC.elion.security.aes_key_length;
    ...
    public RSAPrivateKey getPrivateKey() {
        if (privateKey == null) {
            String key = CC.elion.security.private_key;
            try {
    ...
    public RSAPublicKey getPublicKey() {
        if (publicKey == null) {
            String key = CC.elion.security.public_key;
            try {
